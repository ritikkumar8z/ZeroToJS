...
```mermaid
graph TD
    A[JavaScript Basics] --> B[DOM Manipulation]
    B --> C[Event Handling]
    C --> D[API Integration]
    D --> E[Advanced Projects]
    E --> F[Best Practices]
    F --> G[Portfolio Ready Developer]
...
<div align="center">
<img src="https://github.com/ritikkumar8z.png" width="150" height="150" style="border-radius: 50%;">
